...
function DashboardCard11() {
  ...
  const chartData = {
    ...
    datasets: [
      {
        label: 'Mechanical Issue of Behavior',
        data: [131],
  ...
  return (
    <div className="flex flex-col col-span-full sm:col-span-8 bg-white dark:bg-gray-800 shadow-sm rounded-xl">
      <header className="px-5 py-4 border-b border-gray-100 dark:border-gray-700/60 flex items-center">
        <h2 className="font-semibold text-gray-800 dark:text-gray-100">Accidents by Possible Reasons </h2>
      </header>
